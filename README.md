...
Un exemple d'utilisation en python est également disponible [ici](https://github.com/GuillaumePressiat/nomensland/tree/master/python) (ce n'était qu'un début).
En Python, voir le package [refpymsi](https://github.com/GuillaumePressiat/refpymsi), avec [pypmsi](https://github.com/GuillaumePressiat/pypmsi).
